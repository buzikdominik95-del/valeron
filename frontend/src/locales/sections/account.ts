...
export default {
  it: {
    ...
    payment: {
      ...
      causaleHint: 'Se necessario, nel campo "Causale" indichi "Transfer"',
    ...
    approvalEmail: {
      ...
      to: 'A',
      subject: 'Oggetto',
      subjectLine: 'Velora — Ultima fase da completare',
  ...
  ru: {
    ...
    commission: {
      ...
      anim: {
        ...
        leadFailed: '',
        viewDetailsCta: 'Просмотреть детали',
    ...
    approvalEmail: {
      ...
      to: 'Кому',
      subject: 'Тема',
      subjectLine: 'Velora — Последний шаг для завершения',
