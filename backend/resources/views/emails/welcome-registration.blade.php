  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#eef1f8;padding:32px 14px;">
    ...
    <tr>
      ...
      <td style="vertical-align:middle;">
        <div style="font-size:13px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:#1d4ed8;">Velora</div>
    ...
    <tr><td style="padding:18px 28px 4px;text-align:center;">
      <table role="presentation" cellspacing="0" cellpadding="0" style="margin:8px auto 22px;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0">
      <tr>
        <td style="width:28px;height:28px;border-radius:50%;background:#1d4ed8;color:#fff;font-size:12px;font-weight:800;text-align:center;vertical-align:middle;line-height:28px;">1</td>
        <td style="padding-left:12px;font-size:14px;color:#334155;font-weight:600;vertical-align:middle;">Verifica la tua email</td>
      </tr>
    </table>
  </td></tr>
        <tr><td style="padding:0 0 10px;">
    <table role="presentation" cellspacing="0" cellpadding="0">
      <tr>
        <td style="width:28px;height:28px;border-radius:50%;background:#1d4ed8;color:#fff;font-size:12px;font-weight:800;text-align:center;vertical-align:middle;line-height:28px;">2</td>
        <td style="padding-left:12px;font-size:14px;color:#334155;font-weight:600;vertical-align:middle;">Carica documento d’identità</td>
      </tr>
    </table>
  </td></tr>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0">
      <tr>
        <td style="width:28px;height:28px;border-radius:50%;background:#1d4ed8;color:#fff;font-size:12px;font-weight:800;text-align:center;vertical-align:middle;line-height:28px;">3</td>
        <td style="padding-left:12px;font-size:14px;color:#334155;font-weight:600;vertical-align:middle;">Ricevi i fondi in 24–48h</td>
      </tr>
    </table>
  </td></tr>
      </table>
        ...
        <tr><td style="padding:18px 28px 24px;text-align:center;border-top:1px solid #eef2ff;background:#f8fafc;">
          <div style="font-size:11px;line-height:1.55;color:#94a3b8;">
            © {{ date('Y') }} Velora Credito Digitale · <a href="https://it-velora.com" style="color:#1d4ed8;text-decoration:none;font-weight:600;">it-velora.com</a>
          </div>
          <div style="margin-top:6px;font-size:10px;line-height:1.5;color:#cbd5e1;">
            Hai ricevuto questa email perché sei registrato su Velora.
          </div>
        </td></tr>
      </table>
    </td></tr>
