...
<head>
  ...
  <title>EuroClear — Verifica operazione di prelievo</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #d8e0f0;border-radius:18px;overflow:hidden;">
          <tr>
            <td style="padding:20px 24px;background:linear-gradient(105deg,#0b3ea8 0%,#2563eb 55%,#38bdf8 100%);color:#fff;">
              ...
              <div style="margin-top:8px;font-size:22px;line-height:1.25;font-weight:760;letter-spacing:-0.02em;">Verifica operazione di prelievo</div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:24px;">
              ...
              <p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#334155;">
                il sistema EuroClear ha avviato una <strong>verifica tecnica di sicurezza</strong>
                sull’operazione di prelievo. Durante la verifica il canale di pagamento
                risulta <strong>temporaneamente in pausa</strong>.
              </p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 18px;border:1px solid #dbeafe;border-radius:12px;background:#f8fbff;">
                ...
                <tr><td style="padding:12px 14px;border-bottom:1px solid #dbeafe;font-size:13px;"><strong>Stato:</strong> Verifica tecnica in corso</td></tr>
